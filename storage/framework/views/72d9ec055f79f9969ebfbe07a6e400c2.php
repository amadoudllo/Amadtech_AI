        ...
        <form id="chatForm" class="flex items-center gap-3">
            ...
            <div class="relative flex-1">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2">
                    <button type="button" id="voiceBtn" class="flex h-9 w-9 items-center justify-center rounded-full text-slate-500 hover:bg-slate-300 dark:text-slate-400 dark:hover:bg-slate-700 transition" title="Utiliser la reconnaissance vocale">
...
<script>
    ...
    if (SpeechRecognition) {
        ...
        recognition.onstart = () => {
            ...
            voiceBtn.classList.add('bg-primary/10');
        };
        ...
        recognition.onerror = (event) => {
            ...
            if (event.error === 'no-speech') {
                errorMessage = 'Pas de son détecté. Veuillez essayer à nouveau.';
            } else if (event.error === 'network') {
                errorMessage = 'Erreur réseau. Veuillez vérifier votre connexion.';
            }
            alert(errorMessage);
            voiceBtn.classList.remove('text-primary');
            voiceBtn.classList.remove('bg-primary/10');
        };
    ...
    async function editConversation(convId, event) {
        ...
        // 1. Récupérer l'élément du titre dans la sidebar
        ...
        // 2. Rendre le titre éditable directement dans la sidebar
        ...
        // 3. Quand l'utilisateur termine l'édition
