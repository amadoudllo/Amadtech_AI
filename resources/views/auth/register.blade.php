    ...
    <div class="auth-container">
        <div class="auth-content">
            ...
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Rejoignez-nous et commencez à utiliser notre assistant IA</p>
            </div>
            ...
            <div class="auth-card">
                ...
                <div class="social-buttons">
                    <button class="btn-social" type="button" title="S'inscrire avec Google">
                    ...
                    <button class="btn-social" type="button" title="S'inscrire avec GitHub">
