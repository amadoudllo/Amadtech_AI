                ...
                <div class="stat-card">
                    ...
                    <form method="POST" action="{{ route('admin.settings.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="admin_email" class="form-input" placeholder="admin@example.com" value="{{ auth()->user()->email }}" />
                        </div>
                ...
                <div class="stat-card mt-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold">{{ env('APP_ENV') }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-slate-400">Mode Debug</p>
                            <p class="text-lg font-semibold">{{ env('APP_DEBUG') ? 'Activé' : 'Désactivé' }}</p>
                        </div>
                    </div>
                </div>
            </div>
