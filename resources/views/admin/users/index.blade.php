        ...
        <div class="flex-1 overflow-y-auto p-8">
            ...
            <div class="stat-card mb-6">
                <form method="GET" class="flex gap-4">
                    <input type="text" name="search" placeholder="Rechercher par nom ou email..." value="{{ request('search') }}" class="flex-1 px-4 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-100 placeholder-slate-400" />
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3 class="text-lg font-semibold">Utilisateurs ({{ $users->total() }})</h3>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-700">
                            ...
                            <tr class="hover:bg-slate-800/50 transition">
                                ...
                                <td class="px-6 py-3 text-sm text-slate-400">{{ $user->email }}</td>
                                ...
                                <td class="px-6 py-3 text-sm text-slate-400">{{ $user->created_at->format('d/m/Y') }}</td>
                                <td class="px-6 py-3 text-sm">
                                    <div class="flex gap-2">
                                        <button class="btn-danger" onclick="blockUser({{ $user->id }})">
